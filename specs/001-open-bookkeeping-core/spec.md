...
**Created**: 2026-02-20  
**Status**: Draft  
**Input**: User description: "開源個人記帳理財工具 MVP — 包含收支紀錄管理、分類系統、月度摘要、視覺化圖表、預算追蹤、CSV 匯出匯入、伺服器端資料儲存"
...
- 使用者以不同瀏覽器或裝置開啟同一站台時，看到的資料一致（伺服器端儲存特性）
...
- 使用者使用的是現代瀏覽器（Chrome、Firefox、Safari、Edge 的近兩個主要版本）
